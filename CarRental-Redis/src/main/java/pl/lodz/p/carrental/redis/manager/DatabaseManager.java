...
import pl.lodz.p.carrental.redis.model.client.*;
import pl.lodz.p.carrental.redis.model.vehicle.Bicycle;
import pl.lodz.p.carrental.redis.model.vehicle.Car;
import pl.lodz.p.carrental.redis.model.vehicle.Moped;
...
public class DatabaseManager {
    ...
    public void dataLoader() {
        ...
        Client c5 = new ClientPlatinum("Krzysztof Wójcik", "krzysztof@test.com", 100000.0, adr5.getId());
